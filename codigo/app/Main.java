...
public class Main {
    ...
    private static void menuEscolha(String escolha) throws Exception {
        switch (escolha) {
    ...
    private static void printaMenu(String escolha) throws Exception {
        Scanner teclado = new Scanner(System.in);
        ...
        while (!escolha.equals("0")) {
            ...
            System.out.println("[11] -> Buscar a rota por data");
